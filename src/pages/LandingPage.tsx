...
export default function LandingPage() {
  ...
  return (
    <div ref={containerRef} onWheel={(e)=>handleScroll(e)} className=' scroll-smooth relative h-screen bg-black font-ruddy overflow-y-hidden'>
        ...
        <button onClick={()=>navigate("/signup")} className='fixed font-ruddy bg-red-600 bottom-10 left-1/2 z-20 text-white font-bold tracking-wide p-3 peer -rotate-3 hover:text-red-600 hover:bg-white hover:border hover:border-red-600 hover:rotate-3 transition-all ease-linear'>Register Now</button>
